CREATE TABLE users (id int(10) NOT NULL AUTO_INCREMENT, username varchar(20) NOT NULL UNIQUE, password varchar(255) NOT NULL, email varchar(50) NOT NULL UNIQUE, name varchar(255) NOT NULL, employee_number int(10), payment_type bit(1) DEFAULT 0 NOT NULL, discount int(2), user_status tinyint, logins int(10) DEFAULT 0 NOT NULL, last_login int(10) DEFAULT Null, surname varchar(20), patronymic varchar(255), floor varchar(11) NOT NULL, office varchar(20) NOT NULL, building varchar(20) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE dish_portion (dish_id int(10) NOT NULL, portion_type_id int(10) NOT NULL);
...
ALTER TABLE dish_portion ADD INDEX FKdish_porti275882 (dish_id), ADD CONSTRAINT FKdish_porti275882 FOREIGN KEY (dish_id) REFERENCES dishes (dish_id);
ALTER TABLE dish_portion ADD INDEX FKdish_porti532376 (portion_type_id), ADD CONSTRAINT FKdish_porti532376 FOREIGN KEY (portion_type_id) REFERENCES portion_type (id);
