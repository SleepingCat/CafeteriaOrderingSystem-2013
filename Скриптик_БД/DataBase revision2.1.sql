...
ALTER TABLE roles_users ADD INDEX FKroles_user4608 (role_id), ADD CONSTRAINT FKroles_user4608 FOREIGN KEY (role_id) REFERENCES roles (role_id);
ALTER TABLE roles_users ADD INDEX FKroles_user813314 (user_id), ADD CONSTRAINT FKroles_user813314 FOREIGN KEY (user_id) REFERENCES users (user_id);
