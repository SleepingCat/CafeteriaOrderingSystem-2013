	...
	$("#payment_cell").tooltip(
	{
		...
		{		
			if (document.getElementById("payment_type").checked)			
				return "Нажмите на это поле, если вы отказываетесь оплачивать заказы<br>посредством удержания из зарплаты (будьте аккуратны, так как<br>вы можете снимать галку только раз в месяц)";
			else
				return	"Нажмите на это поле, если вы собираетесь оплачивать заказы<br>посредством удержания из зарплаты (будьте аккуратны, так как<br>вы можете поставить галку только раз в месяц)";		
	    },
