...
function showMe (box)
{
var vis = (box.checked) ? "Если вы нажали на эту галку,значит вы собираетесь оплачивать заказы посредством удержания из зарплаты(будьте аккуратны, т.к вы можете поставить галку только раз в месяц)" : "Если вы сняли галку,значит вы отказываетесь оплачивать заказы посредством удержания  из зарплаты(будьте аккуратны, т.к вы можете снимать галку только раз в месяц)";
	{
	 alert(vis);	
	}
}
