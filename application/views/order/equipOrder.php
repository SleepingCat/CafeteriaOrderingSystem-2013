...
<label>Всего заказов на интервал:<input type = "text" name = "totalOrder" Value = "<?php echo Arr::get(maxOrders) ?>" size = 5></label> 
<div align = "right"> <label>Осталось укомплектовать:<input type = "text" name = "balance" value = "3" size = 5></label></div><br>
