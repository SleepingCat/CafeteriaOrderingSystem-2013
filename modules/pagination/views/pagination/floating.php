...
<p class="pagination">
	...
	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('Последняя ') ?></a>
	<?php else: ?>
		<?php echo __('Первая ') ?>
	<?php endif ?>
	...
	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('Предыдущая ') ?></a>
	<?php else: ?>
